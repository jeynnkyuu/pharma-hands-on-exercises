...
######################################################################
# custom_bar_plot <- function(data, x_var, y_var, title = "<Enter Text>", subtitle = "<Enter Text>") {
...
# Snippet template for a reusable plot function
######################################################################
# create_plot <- function(data, x_var, y_var, title = "<Enter Text>", subtitle = "<Enter Text>") {
#   ggplot(${1:data}, aes(x = ${2:x_variable}, y = ${3:y_variable})) +
#     geom_col(color = "black", fill = "#0072B2") +
#     theme_minimal() +
#     theme(
...
#     xlab("") +
#     ylab("") +
#     geom_text(aes(label = ${3:y_variable}),
#               vjust = 1.5,
#               colour = "white",
#               position = position_dodge(0.9),
#               size = 5) +
#     ggtitle("${4:Main Title}", subtitle = "${5:Subtitle}")
# }
######################################################################
